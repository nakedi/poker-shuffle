...
public class PockerService {
    ...
    public PokerGameDTO shuffleAndDeal(Integer numberOfPlayers){
        ...
        int numberOfCardsAvailableForPlayers = deck.deckType().cardLimit() - (dealService.getGameType().getCardsPerHand() * numberOfPlayers);

        if(numberOfCardsAvailableForPlayers < dealService.getGameType().getCardsPerHand() ){
